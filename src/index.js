...
var NotionClient = /** @class */ (function () {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_c) {
        switch (_c.label) {
          case 0:
            if (
              !((_a = this.parents) === null || _a === void 0
                ? void 0
                : _a.length)
            )
              return [3 /*break*/, 5];
  ...
  NotionClient.prototype._dbQuery = function (
    databaseId,
    filter,
    page_size,
    start_cursor,
  ...
  NotionClient.prototype._childrenQuery = function (block_id) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          this.client.blocks.children.list({ block_id: block_id }),
        ];
      });
    });
  };
  NotionClient.prototype._populateChildDBs = function (page_id) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [4 /*yield*/, this._childrenQuery(page_id)];
          case 1:
            children = _b.sent();
            DBS = {};
        ...
        switch (_c.label) {
          ...
          case 2:
            if (
              ...
              return [3 /*break*/, 4];
            totalResults = __spreadArray(
              __spreadArray([], totalResults, true),
              response.results,
              true,
            );
            ...
            return [
              4 /*yield*/,
              this._dbQuery(databaseId, query, pageSize, response.next_cursor),
            ];
          case 3:
            response = _c.sent();
            return [3 /*break*/, 2];
          case 4:
            ...
            pageResults = totalResults.slice(
          ...
          case 5:
            ...
            return [
              4 /*yield*/,
              (0, scraper_1.sanitizeEntry)(
                __assign({ id: pageResult.id }, pageResult.properties),
              ),
            ];
          case 6:
            _b.apply(_a, [_c.sent()]);
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            response = _a.sent();
            if (!response.results.length) return [2 /*return*/, null];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this._pageQuery(id).catch(function (e) {
                return null;
              }),
            ];
          case 1:
            ...
            return [
              ...
              response
                ? (0, scraper_1.sanitizeEntry)(
                    __assign({ id: response.id }, response.properties),
                  )
                : null,
            ];
        }
  ...
  NotionClient.prototype.create = function (alias, properties) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [
          2 /*return*/,
          this._createQuery(this.mappings[alias], properties),
        ];
      });
    });
  };
