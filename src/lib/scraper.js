      ...
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            fetch(
              "https://filepod.keepish.net?url=".concat(
    ...
    return __generator(this, function (_d) {
      switch (_d.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            (0, exports.eternifyFile)(sanitized[field][i].file.url),
          ];
        case 3:
          newUrlRes = _d.sent();
          sanitized[field][i].file.url = "https://filepod.keepish.net/".concat(
            newUrlRes,
          );
          _d.label = 4;
        case 4:
